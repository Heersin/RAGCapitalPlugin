...
/**
 * This template can be used if you want to create a new Custom Action that 
 * displays information to its own GUI. 
 * <p/>
 * To use, you should:
 * <ol>
 ...
 * </ol>
 */
public class TemplateGUIAction implements IXLogicAction, IXIntegratorAction, IXHarnessAction
{

	/**
	 * We should always have a public-default constructor for any plugin.
	 */
	public TemplateGUIAction()
	{
	}
	...
	{
		// Create your dialog using the name of the action as the title of the dialog (recommended).
		// You should use a modal 'JDialog' rather than a non-modal 'JDialog' or a normal 'JFrame'.
		JDialog dialog = new JDialog(applicationContext.getParentFrame(), true);
