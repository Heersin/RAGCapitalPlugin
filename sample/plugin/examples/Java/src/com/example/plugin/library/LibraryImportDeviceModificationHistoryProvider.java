...
public class LibraryImportDeviceModificationHistoryProvider implements IXLibraryModificationHistoryProvider<IXLibraryDevice>
{
	...
	@Override public String getModificationNote(IXLibraryDevice libObj)
	{
		...
		if(typeCodeName != null && !typeCodeName.equalsIgnoreCase(transtypeCodeName)){
			return "Import : Part " + partNumber + " Type Code changed from " + typeCodeName + " to " + transtypeCodeName;
		}
