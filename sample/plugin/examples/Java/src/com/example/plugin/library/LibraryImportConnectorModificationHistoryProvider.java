...
public class LibraryImportConnectorModificationHistoryProvider implements IXLibraryModificationHistoryProvider<IXLibraryConnector>
{
	...
	@Override public String getModificationNote(IXLibraryConnector libObj)
	{
		...
		if(cavityCount != null && !cavityCount.equalsIgnoreCase(transcavityCount)){
			return "Import : Part " + partNumber + " cavity count changed from " + cavityCount + " to " + transcavityCount;
		}
		return "Library Part " + partNumber + " imported";
	}
}