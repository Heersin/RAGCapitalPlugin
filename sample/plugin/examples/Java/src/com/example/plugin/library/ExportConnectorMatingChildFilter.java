...
public class ExportConnectorMatingChildFilter implements IXObjectFilter<IXLibraryConnectorMating>
{
	...
	@Override public Collection<IXLibraryConnectorMating> apply(Collection<IXLibraryConnectorMating> candidateObjects)
	{
		...
		for (IXLibraryConnectorMating connMate : candidateObjects) {
			...
			if ("ConMate".equalsIgnoreCase(owingpartNumber) &&
					"ConMate2".equalsIgnoreCase(matedPartNumber)) {
				continue;
			}
