 ...
 * | File Templates.
 */
public class WireCSALessThanPointFiveQuery extends BaseCustomFilterExpression
{

	public WireCSALessThanPointFiveQuery()
	{
		super("WireCSA <= 0.5", "1.0", "Checks if the wire CSA is less than or equal to 0.5");
	}
