...
public class PlaceByOtherSlotName extends BaseConstraint implements IXPlacementConstraint {
	
	public PlaceByOtherSlotName() 
	{
		super("Place Device by Other Slot Name",
			  "1.0",
			  "Basic constraint to place devices into slots based on mis-matching names");
	}

	public boolean match(IXDevice device, IXSlot slot, IXDoDontResult result) {
		result.setValue(IXDoDontResult.DoDont.DO);
