...
public class DontCreateBypassWiringConstraint
		extends BaseConstraint
		implements IXCreateBypassWiringConstraint
{
	public DontCreateBypassWiringConstraint()
	{
		super("DontCreateBypassWiringConstraint", "0.1", "Don't create any bypass wiring");
	}

	public boolean match(IXSplice ixSplice, IXBundle ixBundle, IXDoDontResult ixDoDontResult)
	{
		ixDoDontResult.setValue(IXDoDontResult.DoDont.DONT);
		return true;
	}
