...
import com.mentor.chs.plugin.constraint.IXFunctionalModuleAssignationConstraint;
 ...
 */
public class FunctionalPropertyToCodeAssignationConstraint
		extends AbstractPropertyToCodeAssignationConstraint
		implements IXFunctionalModuleAssignationConstraint
{

	public FunctionalPropertyToCodeAssignationConstraint()
	{
		super("FunctionalPropertyToCodeAssignationConstraint",
				"1.1",
	...
	{
		return getPropertyValue("property.name.functional.separator", ",");
	}

	@Override
	protected String getNameOfProperty()
	{
		return getPropertyValue("property.name.functional", "FuncModules");
	}

	@Override public boolean assignModuleCodes(
			Set<IXModuledObject> objects,
			IXHarnessDesign design,
			IXModuleAssignationResult<IXFunctionalModuleCode> result)
	{
