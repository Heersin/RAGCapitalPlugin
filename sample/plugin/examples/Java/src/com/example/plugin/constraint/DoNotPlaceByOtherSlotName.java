...
public class DoNotPlaceByOtherSlotName extends BaseConstraint implements IXPlacementConstraint {

	public DoNotPlaceByOtherSlotName() 
	{
		super("Do Not Place Device by Other Slot Name",
			  "1.0",
			  "Basic constraint to forbid placement of devices into slots based on mis-matching names");
	}
