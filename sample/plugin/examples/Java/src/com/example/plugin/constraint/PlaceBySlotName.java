...
public class PlaceBySlotName extends BaseConstraint implements IXPlacementConstraint {
	
	public PlaceBySlotName() {
		super("Place By Slot Name", 
			  "1.0",
			  "Basic constraint to place devices into slots based on matching names");
	}
