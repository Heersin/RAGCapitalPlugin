...
/**
 * A client implementation for an example external web service deployed in CIS
 */
public class DesignWireListReporterClient extends AbstractClient
{
	public DesignWireListReporterClient() throws Exception
	{
	}

	protected String getWebServiceName()
	{
		return "DesignWireListReporterService";
	}

	protected URL getServiceURL() throws MalformedURLException
	{
		return new URL("http", CIS_HOST, CIS_PORT, "/DemoWebApp/" + getWebServiceName());
	}
