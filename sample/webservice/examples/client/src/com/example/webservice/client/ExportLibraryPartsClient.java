...
{
	public ExportLibraryPartsClient () throws Exception
	{
	}
	...
	{
		return "<Parts includescoping=\"true\" exportrevisions=\"true\"><Part partnumber=\"connector\"/><Part uid=\"UIDe69c0a-1152dcc767d-f528764d624db129b32c21fbca0cb8d6\"/></Parts>";
	}
	...
	protected void processResponse(Document responsePayload) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/exported-LibraryParts.xml";
