 ...
 */
public class ListTasksClient extends AbstractClient
{
	public ListTasksClient() throws Exception
	{
	}
	...
	{
		return "<criteria><names> <name value='HarnessProcessingTask'/></names><statuses> <status value='PENDING'/> </statuses></criteria>";
	}
