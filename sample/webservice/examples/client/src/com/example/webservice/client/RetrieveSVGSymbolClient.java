...
/**
 * A concrete implementation for the CIS "SVGSymbol" web service client.
 */
public class RetrieveSVGSymbolClient extends AbstractClient
{
	public RetrieveSVGSymbolClient() throws Exception
	{
	}
	...
	{
		return "<symbol libname='symbollib' name='symb1'/>";
	}
	...
	protected void processResponse(Document responsePayload) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/RetrieveSVGSymbolClient.svg";
		WebServiceUtils.writeDOMDocumentToFile(responsePayload, filePath);
		System.out.println("SVG symbol successfully written to: " + filePath);
	}
}
