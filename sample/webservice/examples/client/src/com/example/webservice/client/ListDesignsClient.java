...
/**
 * A concrete implementation for the CIS "ListDesigns" web service client.
 */
public class ListDesignsClient extends AbstractClient
{
	public ListDesignsClient() throws Exception
	{
	}
