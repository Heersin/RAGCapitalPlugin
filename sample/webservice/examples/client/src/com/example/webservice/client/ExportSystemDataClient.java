...
/**
 * A concrete implementation for the CIS "ExportSystemData" web service client.
 */
public class ExportSystemDataClient   extends AbstractClient
{
	public ExportSystemDataClient  () throws Exception
	{
	}
	...
	protected void processResponse(Document responsePayload) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/system_data.xml";
		WebServiceUtils.writeDOMDocumentToFile(responsePayload, filePath);
		System.out.println("XML System data successfully written to: " + filePath);
	}
}
