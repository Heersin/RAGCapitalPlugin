...
/**
 * A concrete implementation for the CIS "ExportProjectDesign" web service client,
 * using the new SOAP with attachments format
 */
public class ExportDesignAsAttachmentClient extends AbstractClient
{
	public ExportDesignAsAttachmentClient() throws Exception
	{
	}

	protected String getWebServiceName()
	{
		return "ExportProjectDesign";
	}

	protected String getRequestPayload()
	{
		return "<wiringdesign name='Design1' projectname='example1' asattachment='true'/>";
	}
	...
	protected void processResponseAttachments(SOAPMessage messageSOAP) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/example1-attach-Design1.gz";
