 ...
 */
public class ExportProjectTemplateClient  extends AbstractClient
{
	public ExportProjectTemplateClient () throws Exception
	{
	}
	...
	protected void processResponse(Document responsePayload) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/example1-Project.xml";
		WebServiceUtils.writeDOMDocumentToFile(responsePayload, filePath);
		System.out.println("XML Project Template successfully written to: " + filePath);
	}
}
