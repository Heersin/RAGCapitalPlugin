...
/**
 * A concrete implementation for the CIS "ExportSecurityData" web service client.
 */
public class ExportSecurityDataClient extends AbstractClient
{
	public ExportSecurityDataClient() throws Exception
	{
	}

	protected String getWebServiceName()
	{
		return "ExportSecurityData";
	}

	protected String getRequestPayload()
	{
		return "<SecurityMgr currentuser='false'/>";
	}
