 ...
 */
public class ExportDesignClient extends AbstractClient
{
	public ExportDesignClient() throws Exception
	{
	}
	...
	protected void processResponse(Document responsePayload) throws Exception
	{
		...
		String filePath = OUTPUT_DIRECTORY + "/example1-Design1.xml";
		WebServiceUtils.writeDOMDocumentToFile(responsePayload, filePath);
		System.out.println("XML design successfully written to: " + filePath);
	}
}
