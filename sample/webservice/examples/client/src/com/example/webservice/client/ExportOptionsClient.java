...
/**
 * A concrete implementation for the CIS "ExportOptions" web service client.
 */
public class ExportOptionsClient extends AbstractClient
{
	public ExportOptionsClient() throws Exception
	{
	}
