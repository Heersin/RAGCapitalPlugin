...
/**
 * A concrete implementation for the CIS "ExportDeviceUsages" web service client.
 */
public class ExportDeviceUsageClient extends AbstractClient
{
	public ExportDeviceUsageClient() throws Exception
	{
	}

	protected String getWebServiceName()
	{
		return "ExportDeviceUsages";
	}

	protected String getRequestPayload()
	{
		return "<project name='example1'><usagedef name='dev1'/></project>";
	}
