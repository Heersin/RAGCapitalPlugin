...
/**
 * A web service that implements the "Component Status Change" CHS hook
 */
public class LibraryComponentStatusChangeHookService extends AbstractService
{
	public Document invoke(Document requestPayload) throws Exception
	{
		String request = WebServiceUtils.writeDOMDocumentToString(requestPayload);
